...
public class SensorSimulator {
    ...
    // Simulates one reading per minute for the estimated duration of the ride
    ...
    private AudioData generateAudio() {
        ...
        double  sustainedSeconds = random.nextDouble() * 20; // 100–4000 Hz
        boolean isSpiking = random.nextDouble() < 0.15;       // 15% chance of spike
    ...
    private MotionData generateMotion() {
        ...
        double acc_x = random.nextDouble() * 6;        // 0–6 m/s²
        double acc_y = random.nextDouble() * 6;        // 0–6 m/s²
        double acc_z = random.nextDouble() * 6;        // 0–6 m/s²
